...
public class TimeSpanTest {
    ...
    public void testTimeSpanGood()
    {
        ts1 = new TimeSpan2(t1, t2);
        assertNotNull(ts1);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testTimeSpanBad()
    {
        ts1 = new TimeSpan2(t2, t1);
    }
    ...
    public void testGetBeginTime()
    {
        ...
        TimeSpan instance = (TimeSpan) ts1;
        ITime expResult = t1;
    ...
    public void testSetBeginTime()
    {
        ...
        ITime beginTime =  t1;
        TimeSpan instance = (TimeSpan) ts2;
